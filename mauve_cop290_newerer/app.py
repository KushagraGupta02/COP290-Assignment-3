...
app.config['UPLOAD_FOLDER'] = '/Users/harsh/Documents/Mauve Versions/mauve_cop290_newerer/static/uploads'
...
def viewChats(friendname):
    ...
    cursor.close()
    return render_template("Chats.html", friendname=friendname, sentToMe=sentToMe, sentByMe = sentByMe,ourChats=ourChats)
